...
Свёрнутые окна не учитываются: подсвечивается то, что действительно
видно на экране под указателем. Внутренние элементы определяются не во
всех приложениях — современные наборы виджетов рисуют содержимое окна
целиком и отдельных окон для кнопок и панелей не создают.
